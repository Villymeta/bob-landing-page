...
export async function POST(req) {
  try {
    ...
    // 3️⃣ Log full receipt (with shipping method)
    const receiptsRange = "Receipts!A:N"; // Added column N for shippingMethod
    const itemsJson = JSON.stringify(items);
    const shippingMethod = customer?.shippingMethod || "shipping"; // fallback to "shipping"
